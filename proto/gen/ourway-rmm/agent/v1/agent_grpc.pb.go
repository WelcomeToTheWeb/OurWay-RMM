...
const (
	AgentService_Enroll_FullMethodName      = "/ourway_rmm.agent.v1.AgentService/Enroll"
	AgentService_Stream_FullMethodName      = "/ourway_rmm.agent.v1.AgentService/Stream"
	AgentService_RefreshLeaf_FullMethodName = "/ourway_rmm.agent.v1.AgentService/RefreshLeaf"
)
...
type AgentServiceClient interface {
	...
	// signs a fresh short-lived leaf (OURWAY_RMM_LEAF_TTL, default ~1h) and the
...
func (c *agentServiceClient) Enroll(ctx context.Context, in *EnrollRequest, opts ...grpc.CallOption) (*EnrollResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_Enroll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) RefreshLeaf(ctx context.Context, in *RefreshLeafRequest, opts ...grpc.CallOption) (*RefreshLeafResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_RefreshLeaf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAgentServiceServer) RefreshLeaf(context.Context, *RefreshLeafRequest) (*RefreshLeafResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefreshLeaf not implemented")
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ourway_rmm.agent.v1.AgentService",
	...
	Metadata: "ourway-rmm/agent/v1/agent.proto",
}
